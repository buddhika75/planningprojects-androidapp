...
public class WebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView view = (WebView) this.findViewById(R.id.fullscreen_content);
        view.setWebViewClient(new WebViewClient());
        String url;

            url = baseUrl + "/faces/mobile/index.xhtml?username=" + un + "&password=" + pw;
...
//        System.out.print("URL = " + url);
        ...
        findViewById(R.id.btnHome).setOnTouchListener(mDelayHideTouchListener);
    }
